...
export const Waving = () => (
  <div className="body1">
    ...
    >
      ...
      <pointLight distance={60} intensity={0.5} color="gold" />
      <spotLight
        intensity={1.5}
        position={[0, 0, 2000]}
        penumbra={1}
      ...
      {/* <meshStandardMaterial colo="#f00fff" roughness={0} metalness={0.5} /> */}
      {/* </mesh> */}
      <mesh>
  ...
  return (
    <>
      ...
      <instancedMesh ref={mesh} args={[null, null, count]}>
        ...
        <meshStandardMaterial color="#fff00f" roughness={0} metalnes={1} />
      </instancedMesh>
    </>
  );
}
